...
class TestBurger:
    ...
    def test_remove_ingredient(self, mock_sauce, mock_filling):
        ...
        assert burger.ingredients == [mock_filling] and len(burger.ingredients)==1 
    ...
    @pytest.mark.parametrize("bun_price, ing_1_price, ing_2_price, expected_price", ResultTest.PRICE_TEST_CASE)
    def test_get_price(self, bun_price, ing_1_price, ing_2_price, expected_price):
        #Arrange
        mock_bun = Mock()
